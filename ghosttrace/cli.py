...
app = typer.Typer(add_completion=False, help="GhostTrace experiment and reporting tools.")
console = Console()
...
def report(run_dir: str) -> None:
    """Aggregate a finished run into results.json and report cards."""
...
def figs(run_dir: str) -> None:
    """Render paper figures for a finished run."""
