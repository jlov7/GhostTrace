...
| C10 | Text leakage inflates apparent LLM transfer | planned (needs committed contaminated-run artifact) | — | No committed contaminated-run artifact backs an asserted claim |
