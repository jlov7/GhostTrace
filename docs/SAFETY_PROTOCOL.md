...
- The sanitizer removes explicit trait-token forms and records a per-arm
  visible-semantics fingerprint that is invariant to that removal. Independently
  generated treated and control text is not expected to have the same fingerprint.
